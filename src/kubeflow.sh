...
main () {
  ...
  #kubectl apply -k "github.com/kubeflow/pipelines/manifests/kustomize/env/dev?ref=${THIS_KUBEFLOW_PIPELINE_VERSION}"
  ...
  kubectl apply -k "github.com/kubeflow/pipelines/manifests/kustomize/env/cert-manager/platform-agnostic-k8s-native?ref=${THIS_KUBEFLOW_PIPELINE_VERSION}"
