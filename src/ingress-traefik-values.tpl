...
ingressRoute:
  dashboard:
    ...
    matchRule: Host(`${THIS_TRAEFIK_HOST}.${THIS_DOMAIN}`) 
    ...
    middlewares: 
      - name: "default-traefik-auth@kubernetescrd"
    # -- TLS options (e.g. secret containing certificate)
    tls:
      secretName: ${THIS_NAME}-traefik-ingress-tls
  healthcheck:
...
logs:
  general:
    ...
    level: "${THIS_TRAEFIK_LOG_LEVEL}"  # @schema enum:[TRACE,DEBUG,INFO,WARN,ERROR,FATAL,PANIC]; default: "INFO"
